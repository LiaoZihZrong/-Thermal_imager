...
#e01-推東西-tozreo-inv二值化
import os

try:
    os.makedirs('./e01-out/to/')
except:
    print("OK:build=./e01-out/to/")

for i in range(9):
    #讀取第一張
    if i == 0 :
        img_name = "./e01/e01" + str(i + 1) + ".jpg"
        ...
        img_name1= "./e01/e01" + str(i ) + ".jpg"
        img_name2= "./e01/e01" + str(i + 1) + ".jpg"
        #print(i+2,"-YES")
        ...
        output_tru_name="./e01-out/to/e01-out-to-"+str(i)+".jpg"
...
cv2.imwrite("./e01-out/e01-color-out.jpg", add_img_sub)
cv2.imwrite("./e01-out/e01-to-out.jpg", tru_add_img_sub)
#顯示最終結果
