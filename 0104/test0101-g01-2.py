...
#g01-踢東西-tozreo-inv二值化
import os

try:
    os.makedirs('./g01-out/to/')
except:
    print("OK:build=./g01-out/to/")
...
for i in range(9):
    ...
    if i == 0 :
        ...
        output_tru_name="./g01-out/to/g01-out-to-"+str(i)+".jpg"
...
cv2.imwrite("./g01-out/g01-to-out.jpg", tru_add_img_sub)
#顯示最終結果
