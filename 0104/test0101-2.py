...
#f01-畫大圈-tozreo-inv二值化
import os

try:
    os.makedirs('./f01-out/to/')
except:
    print("OK:build=./f01-out/to/")

for i in range(9):
    #讀取第一張
    if i == 0 :
        img_name = "./f01/f01" + str(i + 1) + ".jpg"
        ...
        img_name1= "./f01/f01" + str(i ) + ".jpg"
        img_name2= "./f01/f01" + str(i + 1) + ".jpg"
        #print(i+2,"-YES")
        ...
        output_tru_name="./f01-out/to/f01-out-to-"+str(i)+".jpg"
...
cv2.imwrite("./f01-out/f01-color-out.jpg", add_img_sub)
cv2.imwrite("./f01-out/f01-to-out.jpg", tru_add_img_sub)
#顯示最終結果
