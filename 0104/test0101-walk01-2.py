...
try:
    os.makedirs('./walk01-out/to/')
except:
    print("OK:build=./walk01-out/to/")
...
for i in range(9):
    ...
    if i == 0 :
        ...
        output_tru_name="./walk01-out/to/walk01-out-to-"+str(i)+".jpg"
...
cv2.imwrite("./walk01-out/walk01-color-out.jpg", add_img_sub)
cv2.imwrite("./walk01-out/walk01-to-out.jpg", tru_add_img_sub)
#顯示最終結果
